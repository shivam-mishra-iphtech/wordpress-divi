...
// bootstrap cdn ____________________
...
function enqueue_bootstrap_5() {
    ...
    wp_enqueue_script('bootstrap-5-js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js', array('jquery'), null, true);
}
...
// Enqueue Bootstrap 5 in Divi Child Theme
